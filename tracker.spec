...
%check
desktop-file-validate %{buildroot}%{_datadir}/applications/tracker-needle.desktop
desktop-file-validate %{buildroot}%{_datadir}/applications/tracker-preferences.desktop
